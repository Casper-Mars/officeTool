...
func (_bb Color) AsRGBString() *string {
	return _cd.Stringf("\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _bb._g, _bb._gb, _bb._f)
}
...
func FromHex(s string) Color {
	...
	var _eb, _cc, _a uint8
	_ca, _ := _b.Sscanf(s, "\u0025\u0030\u0032x\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", &_eb, &_cc, &_a)
	if _ca == 3 {
		return RGB(_eb, _cc, _a)
	}
	return Auto
}
...
// to a string containing a six digit hex RGB value.
func (_ee Color) AsRGBAString() *string {
	return _cd.Stringf("\u0025\u00302\u0078\u0025\u00302\u0078\u0025\u0030\u0032\u0078\u0025\u0030\u0032\u0078", _ee._e, _ee._g, _ee._gb, _ee._f)
}
...
func (_bg Color) IsAuto() bool { return _bg._fe }
